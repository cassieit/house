...
<div class="content">
    <div class="width1190">
        <div class="reg-logo">
            <form id="signupForm" method="post" action="/adminController/checkLogin" class="zcform">
                <p class="clearfix">
                    <label class="one" for="agent">用户名：</label>
                    <input id="agent" name="admin_name" type="text" class="required" value placeholder="请输入您的用户名" />

                </p>
                <p class="clearfix">
                    <label class="one"  for="password">登录密码：</label>
                    <input id="password" name="admin_pwd" type="password" class="{required:true,rangelength:[8,20],}" value placeholder="请输入密码" />
                </p>
            ...
            <%--<div class="reg-logo-right">--%>
                <%--<h3>忘记密码？点击重置</h3>--%>
                <%--<a href="repwd.jsp" class="logo-a">重置密码</a>--%>
            <%--</div>--%>
            <%--<div class="clears"></div>--%>
        </div><!--reg-logo/-->
    </div><!--width1190/-->
...
<div class="footer">
    <div class="width1190">
        <div class="fl"><a href="<%=basePath%>index.jsp"><strong>邻居大妈</strong></a><a href="<%=basePath%>about.jsp">关于我们</a><a href="<%=basePath%>contact.jsp">联系我们</a><a href="<%=basePath%>user.jsp">个人中心</a></div>
