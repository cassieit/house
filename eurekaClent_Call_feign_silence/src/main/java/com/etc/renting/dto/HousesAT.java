package com.etc.renting.dto;

public class HousesAT {
    private Integer houses_id;
    private Integer admin_id;
    private Integer area_id;
    private Integer type_id;
    private String houses_name;
    private double houses_price;
    ...
    public double getHouses_price() {
        return houses_price;
    }

    public void setHouses_price(double houses_price) {
    ...
    public String getHouses_state() {
        return houses_state;
    }

    public void setHouses_state(String houses_state) {
        this.houses_state = houses_state;
    }
